...
end_date <- as.POSIXct("2024-11-30 00:00:00")
...
write.csv(CRDS.long, "2024_Nov_16_to_30_CRDS.long.csv", row.names = FALSE)

CRDS.long <- fread("2024_Nov_16_to_30_CRDS.long.csv")
...
write.csv(CRDS.long_in, "2024_Nov_16_to_30_CRDS.inside.csv", row.names = FALSE)
